...
# CSS para botones cuadrados y simétricos
st.markdown("""
    <style>
    div.stButton > button {
        width: 100%;
...
# Botones con callbacks (variables)
col1, col2, col3, col4, col5 = st.columns(5)
with col1: st.button("p", on_click=add_symbol, args=("p",))
with col2: st.button("q", on_click=add_symbol, args=("q",))
with col3: st.button("r", on_click=add_symbol, args=("r",))
with col4: st.button("a", on_click=add_symbol, args=("a",))
with col5: st.button("b", on_click=add_symbol, args=("b",))
...
with col12: st.button(")", on_click=add_symbol, args=(")",))
with col13: st.button("Borrar", on_click=clear_expr)

# Botones de control
col14, col15 = st.columns(2)
with col14: st.button("←", on_click=backspace)
with col15: st.button("Calcular", on_click=calcular)
